...
public class HandMenuManager : MonoBehaviour
{
    ...
    {
        GameObject activeModel = GameObject.FindGameObjectWithTag(Tags.ActiveModel);
        if (activeModel != null)
        {
    ...
    {
        GameObject asset = GameObject.FindGameObjectWithTag(Tags.ActiveModel);
        if (asset == null)
        {
            return;
        }
    ...
    public void ModelDelete()
    {
        ...
        if (PV.IsMine)
        {
            GameObject[] toolTips = GameObject.FindGameObjectsWithTag(Tags.OutcropTooltip);
